...
function switchTheme() {
    ...
    localStorage.getItem('themeMode') === 'dark' ? document.querySelector('body').classList.add('dark-background') & document.querySelector('#switch-button').classList.add('fa-sun') :
